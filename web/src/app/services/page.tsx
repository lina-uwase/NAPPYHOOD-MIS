  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      {canManageServices ? (
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div className="flex bg-gray-100 p-1 rounded-lg">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${activeTab === 'discounts'
                ? 'bg-white text-gray-900 shadow-sm'
                : 'text-gray-500 hover:text-gray-900'
                }`}
            >
        ...
        <div className="mb-4">
          {/* If not admin, just show header or nothing specialized, though typically title is enough */}
        </div>
      )}
                ...
                {loading ? (
                  ...
                  Array.isArray(services) && services.map((service) => (
                    <tr key={service.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${service.isActive
