...
router.get('/summary', authenticateToken, getVisitsSummary);
router.get('/customer/:customerId', authenticateToken, getVisitsByCustomer);
...
router.delete('/:id', authenticateToken, requireRole(['ADMIN', 'MANAGER']), deleteVisit);
router.patch('/:id/complete', authenticateToken, completeVisit);
